...
const seeds: Seed[] = [
  ...
  },
  {
    ...
    objective: "Investigate image formation by a convex lens for different object distances.",
    theory: "Lens formula: 1/v − 1/u = 1/f. Magnification m = v/u.",
    apparatus: "Convex lens (f = 15 cm)\nObject\nScreen\n(Simulated)",
