    ...
    <div className="fixed inset-0 z-[9998] flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-6 space-y-5">
          {/* Class selection */}
          <div>
            <p className="text-sm font-black text-gray-700 mb-2.5">Which class are you in?</p>
              ...
              {(["Class IX", "Class X"] as StudentClass[]).map((cls) => (
                <button
                  ...
                  className={`py-4 rounded-2xl font-black text-sm transition-all border-2 ${
                    selectedClass === cls
                      ? "border-purple-600 text-white shadow-lg scale-105"
                      : "border-gray-200 text-gray-600 hover:border-purple-300"
                  }`}
                  style={selectedClass === cls ? { background: "linear-gradient(135deg, #7c3aed, #6d28d9)" } : {}}
                >
          ...
          {/* Medium selection */}
          <div>
            <p className="text-sm font-black text-gray-700 mb-2.5">Which medium do you study in?</p>
            <div className="grid grid-cols-2 gap-3">
