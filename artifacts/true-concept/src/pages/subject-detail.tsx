  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 blob-bg">
      ...
      <div className="relative overflow-hidden liquid-dark rounded-3xl p-6 text-white mb-8">
        ...
        <h1 className="font-black text-3xl sm:text-4xl mb-2 relative" data-testid="heading-subject">{subject?.name}</h1>
        <p className="text-purple-300 font-semibold relative">{subject?.description}</p>
      </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-500 line-clamp-1 font-medium">{chapter.description}</p>
                      {/* Content badges */}
                      <div className="flex gap-2 mt-2 flex-wrap">
                        ...
                        {chapter.hasVideo && (
                          <span className="inline-flex items-center gap-1 text-xs liquid-inner text-rose-700 px-2.5 py-1 rounded-full font-black">🎬 Video</span>
                        )}
                      </div>
                    </div>
